...
names2 = ["Ella", "Owen", "Fred", "Zoe", "Adam", "Ceve", "Adam", "Ceve", "Jonas", "Ola", "Morgan", "Fredrik", "Simon", "Albin", "Måns", "Amer", "David", 'Daniel', 'Ida', 'Marcus','Cedelia','Nils','elis','jimmy','jonathan','erics','viktoria','svennis','tage','stannis','arya','rob','lannister','harry','ron','hermione','Slughorn','dumbledore','hagrid','severus','minerva','sprout','voldemort','umbridge','mårten','smörgåsTÅRTA'] 
